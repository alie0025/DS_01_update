...
unique_players <- length(unique(all_stats$athlete_id))

# Unique players in join
unique_joined  <- nrow(filter(merged_exact, !is.na(athlete_id)))

cat("Unique players with stats:", unique_players, "\n")
cat("Unique players in merged_exact:", unique_joined, "\n")
...
write.csv(streak_summary, "streak_summary.csv")
# ---------------------------------------------------------
# 6. Preview
# ---------------------------------------------------------
